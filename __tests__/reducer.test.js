...
describe("When the reducer", function () {
    var mockState = void 0;
    beforeEach(function () {
        mockState = {
            searchResults: [],
            graphs: [],
    ...
    describe("receives a " + actions_1.SEARCH + " action", function () {
        it("should update the searchResults", function () {
            var companies = [{
                symbol: "msft",
                name: "Microsoft"
            }, {
            ...
            var newState = store_1.reducer(mockState, actions_1.ListSearchResults(companies));
            expect(newState.searchResults).toHaveLength(2);
            expect(newState.searchResults).toEqual(companies);
        });
    });
    describe("receives a " + actions_1.ADD_GRAPH + " action", function () {
        it("should add a new graph to the list", function () {
            var newGraph = {
                type: actions_1.ADD_GRAPH,
                company: {
                    symbol: "msft",
                    name: "Microsoft"
                },
            ...
            var newState = store_1.reducer(mockState, newGraph);
    ...
    describe("receives a " + actions_1.REM_GRAPH + " action", function () {
        var newGraph = void 0;
        beforeAll(function () {
            newGraph = {
                type: actions_1.ADD_GRAPH,
            ...
            mockState = store_1.reducer(mockState, newGraph);
        });
        it("should remove an existing graph", function () {
            var removeGraph = {
                type: actions_1.REM_GRAPH,
                graphId: "graph0"
            };
            var newState = store_1.reducer(mockState, removeGraph);
            expect(newState.graphs).toHaveLength(0);
        });
    });
    describe("receives a " + actions_1.TOGGLE_MODAL + " action", function () {
        var newAction = void 0;
        beforeEach(function () {
            newAction = {
                type: actions_1.TOGGLE_MODAL
            };
        });
        it("should toggle state property showModal", function () {
            var newState = store_1.reducer(mockState, newAction);
            expect(newState.showModal).toBe(true);
        });
        it("should store modal stock symbol, ", function () {
