...
exports.addGraphAsync = function (company) {
    return function (dispatch) {
        var stockRequest = new Request("/stockprice?stocksymbol=" + company.symbol, { method: "GET" });
        return fetch(stockRequest).then(function (res) {
            return res.json();
        }).then(function (json) {
            console.log(json);
            var dataPoints = [];
...
exports.addWatchAsync = function (symbol, targetPrice, phoneNumber) {
    ...
    return function (dispatch) {
        ...
        var bodyBlob = new Blob([JSON.stringify({
            symbol: symbol,
            phone: phoneNumber,
            price: targetPrice
        })]);
        ...
        return fetch(watchRequest).then(function (res) {
            return res.status;
