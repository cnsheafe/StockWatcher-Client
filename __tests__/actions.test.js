...
describe("ListSearchResults", function () {
    it("should return action of type SearchResult", function () {
        var actionCreator = actions.ListSearchResults;
        var companies = [{
            symbol: "msft",
            name: "Microsoft"
        }, {
        ...
        var action = actionCreator(companies);
...
describe("toggleModalDisplay", function () {
    it("should return action of type ToggleModalDisplay", function () {
        var actionCreator = actions.toggleModalDisplay;
        var action = actionCreator("msft");
        expect(action).toHaveProperty("type");
...
describe("RemoveGraph", function () {
    it("should return action of type RemoveGraph", function () {
        var actionCreator = actions.removeGraph;
        var action = actionCreator("graph1");
        expect(action).toHaveProperty("type");
